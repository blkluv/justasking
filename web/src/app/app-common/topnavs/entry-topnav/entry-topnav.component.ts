...
@Component({
  selector: 'app-entry-topnav',
  templateUrl: './entry-topnav.component.html',
  styleUrls: ['./entry-topnav.component.scss']
})
export class EntryTopnavComponent implements OnInit {
